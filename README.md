...
* Gettleburger is a restaurant app that lets users input the names of burgers they'd like to eat, but instead we launch them at their enimies!

* Whenever a user submits a burger's name, your app will display the burger on the left side of the page -- waiting to be shot from a rocket launcher.

* Each burger in the waiting area also has a `FIRE!` button. When the user clicks it, the burger will move to the right side of the page.

* Your app will store every burger in a database, whether launched or not.
